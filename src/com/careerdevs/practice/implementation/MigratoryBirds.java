...
class Result {
    ...
    public static int migratoryBirds(List<Integer> arr) {
        ...
        // Fill HashMap with array values as keys and counts the occurrences to the value
        for (int birdType : arr) {
            if (!birdMap.containsKey(birdType))
                birdMap.put(birdType, 0);
        ...
        for (Map.Entry<Integer, Integer> entry : birdMap.entrySet()) {
            // Compare HashMap's values to determine which is the highest Value and assign to maxEntry
